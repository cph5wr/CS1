...
combine nil l = l
combine (h::t) l = ite (member h l) (combine t l) (h::(combine t l))
...
intersect nil _ = nil
intersect (h::t) l = ite (member h l) (h::(intersect t l)) (intersect t l)
...
list_difference (h::t) l = ite (member h l) (list_difference t l) (h::(list_difference t l))
...
set_forall p (mkSet l) = ite (eql (length (filter (eql_bool true) (map p l))) (length l)) (true) (false)
...
-- Return true if p is true for some v in s, otherwise else false
-- set_exists: (p: a -> bool) -> (s: set a) -> bool
set_exists p (mkSet l) = ite (eql (length (filter (eql_bool false) (map p l))) (length l)) (false) (true)
...
first_choice: list a -> option a
first_choice (h::t) = some h

set_witness p (mkSet l) = ite (set_exists p (mkSet l)) (first_choice (filter p l)) (none)
...
pairelt a nil = nil
pairelt a (h::t) = (mkPair a h) :: (pairelt a t)

pairlist: list a -> list b -> list (pair a b)
pairlist nil l = nil
pairlist (h::t) l = pairelt h l

set_product (mkSet l1) (mkSet l2) = mkSet (pairlist l1 l2)
...
eql_set (mkSet l1) (mkSet l2) = list.same_elements l1 l2
