...
|||A record of this type represents a country and the death rate per 10,000,000 by gun for homocides, suicides, unententional, other
...
listgun: list gunrow
listgun = (cons argen (cons austral (cons austria (cons hond (cons usa nil)))))
